...
public class AuditLogFilter extends OncePerRequestFilter {
    ...
    private void init() {
        ...
        this.inclusionSet = CommonUtil.isEmpty(inclusionSet) ? CommonUtil.setOf(LOG_ALL_PATTERN) : inclusionSet;
    }
    ...
    private String processMessageBody(byte[] content, String contentType, String contentEncoding) {
        ...
        return CommonUtil.safeSubstring(auditLogMessageBodyLimit, builder.toString());
    }
